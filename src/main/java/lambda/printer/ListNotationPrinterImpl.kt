...
internal class ListNotationPrinterImpl: ListNotationPrinter {

    override fun printInListNotation(
        nodes: List<Node>
    ): String {
        return nodes.joinToString(
            ...
            printInListNotation(node)
        }
    }

    override fun printInListNotation(node: Node):String {
