...
class UserDefinedFunctionGeneratorImplTest {
    ...
    private val defunFunction = UserDefinedFunctionGeneratorImpl(
    ...
    fun defunFunctionEmptyFormalParamsTest() {
        ...
        val formalParametersNode = Mockito.mock(ExpressionListNode::class.java)
        val formalParameters = emptyList<String>()
        Mockito.`when`(formalParametersNode.children).thenReturn(listOf())
        ...
        Assertions.assertEquals(body, actual.second.body)
